...
<form id="login_box" method="post" action="http://localhost:8080/oauth/userLogin" autocomplete="off">
    <div id="err_info">
    ...
    <div id="reg"><a href="http://localhost:8080/oauth/register">新用户注册</a></div>
</form>
</body>
</html>